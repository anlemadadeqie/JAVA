...
<div class="lc-block" id="l-login" data-ng-class="{'toggled':lctrl.login === 1}">
    ...
    <form action="/user/updatepass" method="post"  id="formid" name="myform">
        ...
        <div class="input-group m-b-20">
            ...
            <div class="fg-line">
                <input type="password"  name="pa2" class="form-control" id="password2" placeholder="Input Password again" regex="^\w{6,16}$"/>
            </div>
        </div>
