...
<body class="mian_bj">
<form class="mian_top_01" action="/employee/changeemp" method="post">
    ...
    <div class="mian_b">
        ...
        <table width="100%" border="1" cellpadding="0" cellspacing="0" class="mian_b_bg_xz">
            ...
            <tr style="background-color: White; height: 30px">
                <td>
                    <input id="Text1" 　name="username" type="text" style="border: 0px; width: 100px" class="mess">
                </td>
                <td>
                    <select id="Select1" style="width: 80px" class="mess" name="sexs">
                        <option value="男">男</option>
                        <option value="女">女</option>
                    </select>
                </td>
                <td>
                    <input id="Text2" name="births" type="text" style="border: 0px; width: 100px" class="mess">
                </td>
                <td>
                    <input id="Text3"  name="loginnames" type="text" style="border: 0px; width: 100px">
                </td>
                <td>
            ...
            <tr style="background-color: White; height: 30px">
                <td>
                    <input id="Text11"  name="natives" type="text" style="border: 0px; width: 100px" class="mess">
                </td>
                <td colspan="2">
                    <input id="Text12"  name="tels" type="text" style="border: 0px; width: 200px" class="mess">
                </td>
                <td colspan="3">
                    <input id="Text13"  name="mails"  type="text" style="border: 0px; width: 300px" class="mess">
                </td>
                <td>
                </td>
            </tr>
            <tr style="background-color: White; height: 30px">
                ...
                <td colspan="4">
                    <input id="Text7"  name="addresss" type="text" style="border: 0px; width: 300px" class="mess">
                </td>
                <td>
                    邮编：
                </td>
            ...
            <tr style="background-color: White; height: 30px" id="mysub">
                <td align="center" colspan="8">
                    ...
                    <input type="image" src="/images/bnt_05.gif" width="80" height="22">
